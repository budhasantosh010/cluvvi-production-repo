  ...
  .object({
    ...
    config: z
      .object({
        ...
        discoverySourceFamilies: z.array(CluvviSourceFamilySchema).max(5).default([]),
        ...
        discoveryYoutubeDepth: z.enum(["quick", "default", "deep"]).default("default"),
        ...
        specializedContextRuleVersion: z.string().min(1).default("c1-j5.specialized-context.v1"),
        specializedCoverageVersion: z.string().min(1).default("c1-j5.coverage.v1"),
        specializedRegistryVersion: z.string().min(1).default("c1-j5.0"),
