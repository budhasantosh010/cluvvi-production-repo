...
async function createRuntime(): Promise<WebLocalRuntime> {
  ...
  return {
    ...
    service: new LocalCluvviApplicationService({
      ...
      discoveryYoutubeDepth: discoveryConfig.youtubeDepth,
      ...
      videoSignalRuleVersion: discoveryConfig.videoSignalRuleVersion,
      specializedSignalRuleVersion: discoveryConfig.specializedSignalRuleVersion,
